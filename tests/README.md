...
| `tests/native/` | Native Moreau projector integration; includes CVXPY parity and a dual-backend check (`CompiledSolver` vs legacy `moreau.Solver` via `NativeMoreauCompiledOptions.use_compiled_solver`). |
