...
3. For benchmark/governance changes, run `make verify-reference-system`.
4. Read [`docs/CI_MERGE_GATES.md`](docs/CI_MERGE_GATES.md), [`docs/BRANCH_PROTECTION.md`](docs/BRANCH_PROTECTION.md), and [`docs/REFERENCE_EVIDENCE_TIERS.md`](docs/REFERENCE_EVIDENCE_TIERS.md).
